...
with DAG(
    ...
    gcs_bucket = "credit-card-data-analysis1"
    ...
    batch_details = {
        "pyspark_batch": {
            "main_python_file_uri": f"gs://credit-card-data-analysis1/spark_job/spark_job.py"
        },
        "runtime_config": {
            "version": "2.2",
        },
        "environment_config": {
            "execution_config": {
                "service_account": "80186944923-compute@developer.gserviceaccount.com",
